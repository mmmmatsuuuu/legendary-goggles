...
const interviewsTemplate = {
    interview1: {
        count: 3,
        contents: [
            { number: 1, question: "Tell me about yourself", modelAnswer: "I've been a hostess at XYZ Restaurant for just over two years where I greet and seat customers, assess wait times, fulfill to-go orders and answer the phones.", userAnswer: ""},
            { number: 2, question: "How would you describe yourself?", modelAnswer: "I am an ambitious and driven individual.", userAnswer: ""},
            { number: 3, question: "What makes you unique?", modelAnswer: "What makes me unique is my ability to meet and exceed deadlines.", userAnswer: ""},
        ],
    },
    interview2: {
        count: 3,
